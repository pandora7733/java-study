...
public class _04_Operator4 {
    public static void main(String[] args) {
        ...
        System.out.println(chicken || popcorn || soup); // 하나라도 true 이면 true
        System.out.println(chicken && popcorn && soup); // 3개가 모두 true 이면 true
        ...
        // OR 연산
        System.out.println((5>3)||(3>1)); // 5는 3보다 크거나, 3은 1보다 크다 (ture)
